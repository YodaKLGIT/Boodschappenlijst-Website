<x-app-layout>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col items-start">
                    <form action="{{ route('shoppinglist.index') }}" method="GET" class="w-full">
                        <label for="sort" class="block mb-2 text-sm font-semibold text-gray-400">Filters</label>
                        <select id="sort" name="sort" class="border border-gray-300 rounded-md p-2 text-sm w-full text-gray-700" onchange="this.form.submit()">
                ...
                <!-- Combined Centered Content and Shopping Lists Section -->
                                ...
                                <div class="bg-gray-700 rounded-t p-2 transition-all duration-300 ease-in-out">
                                    <div class="flex justify-between items-center p-2">
                                        ...
                                        <div class="relative inline-block text-left">
                                            <button id="dropdownInformationButton-{{ $shoppinglist->id }}" data-dropdown-toggle="dropdownInformation-{{ $shoppinglist->id }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                                Actions
                                            ...
                                            <!-- Dropdown menu -->
                                            <div id="dropdownInformation-{{ $shoppinglist->id }}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownInformationButton-{{ $shoppinglist->id }}">
                                                    <li><a href="{{ route('shoppinglist.show', $shoppinglist->id) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a></li>
                                                    <li><a href="{{ route('shoppinglist.edit', $shoppinglist->id) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a></li>
                                                    <li>
    ...
    <section class="flex justify-center mt-4"></section>
