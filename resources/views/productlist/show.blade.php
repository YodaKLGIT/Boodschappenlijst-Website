    ...
    <div class="container mx-auto px-4 py-8 mb-16">
        @if($productlist->products->isEmpty())
            <div class="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
                <p class="text-gray-600 mb-4">No products available in this list.</p>
                <a href="{{ route('products.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-pink-600 px-4 py-2 text-white hover:bg-pink-700 transition-colors duration-300">
                    <span class="text-sm">Add a new product</span>
        ...
        @endif <!-- Closing the if statement for checking if products are empty -->
    </div>
</x-app-layout>
